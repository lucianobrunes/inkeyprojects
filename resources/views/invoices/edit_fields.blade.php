    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                {{ Form::select('tax_id', $invoiceSyncList['taxes'], isset($invoice->tax_id) ? $invoice->tax_id : null, ['class' => 'form-control tax-select-box', 'id' => 'editTaxId', 'placeholder' => 'Select Tax']) }}
